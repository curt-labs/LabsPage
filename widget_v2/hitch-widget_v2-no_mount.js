        ...
        if(!widget_loaded){
            ...
            jQuery('#model').live('change',function(){
				if(jQuery(this).val() != model){
					...
					jQuery.get('http://docs.curthitch.biz/API/GetStyle?callback=loadCurtStyles',get_data,function(styles){},'jsonp');
					var str = jQuery('#searchStr').text();
...
function loadConfigurator(years){
    ...
    if(jQuery('#configurator').length > 0){
        ...
        loaderHTML = "<img src='//www.curthitch.biz/widget/ajax-loader.gif' id='loader' style='display:none' width='208' height='25' />";
...
function displayPart(part){
    ...
    var partHTML = "<div class='hitch'>";
        partHTML += "<span class='shortDesc_link'>";
            partHTML += "<img class='curtLogo' src='//www.curthitch.biz/widget/logo.png' width='80' style='display:inline' />";
        ...
        partHTML += "<a title='" + part.shortDesc + "' href='//www.curthitch.biz/masterlibrary/"+ part.partID + "/images/" + part.partID + "_1024x768_a.jpg' class='image prodImg'>";
            partHTML += "<img src='//www.curthitch.biz/masterlibrary/"+ part.partID + "/images/" + part.partID + "_300x225_a.jpg' onerror='jQuery(this).parent().remove();' />";
        ...
        partHTML += "<div class='longDesc'>";
            partHTML += "<div class='hitchSpecs'>";
                ...
                partHTML += "<img src='//www.curthitch.biz/widget/file_pdf.png' />";
                partHTML += "<a target='_blank' href='//www.curthitch.biz/masterlibrary/"+part.partID+"/installsheet/CM_"+part.partID+"_INS.pdf'>";
        ...
        partHTML += "<div class='hitchTab_container'>";
            partHTML += "<div class='imageTab_content content' id='"+part.partID+"_content'>";
                partHTML += "<img rel='facebox' src='//www.curthitch.biz/masterlibrary/"+part.partID+"/images/"+part.partID+"_300x225_b.jpg' onerror='jQuery(this).hide()' />";
                partHTML += "<img src='//www.curthitch.biz/masterlibrary/"+part.partID+"/images/"+part.partID+"_300x225_c.jpg' onerror='jQuery(this).hide()' />";
                partHTML += "<img src='//www.curthitch.biz/masterlibrary/"+part.partID+"/images/"+part.partID+"_300x225_d.jpg' onerror='jQuery(this).hide()' />";
                partHTML += "<img src='//www.curthitch.biz/masterlibrary/"+part.partID+"/images/"+part.partID+"_300x225_e.jpg' onerror='jQuery(this).hide()' />";
            partHTML += "</div>";
            if(part.relatedCount > 0){
...
function loadAccessories(partID, related_parts){
    if(related_parts != null && related_parts.length > 0 && partID > 0){
        ...
        jQuery.each(related_parts,function(i,acc){
            ...
            accHTML += '<img onerror="jQuery(this).parent().hide()" src="//www.curthitch.biz/masterlibrary/'+acc.partID+'/images/'+acc.partID+'_300x225_a.jpg" />';
            accHTML += '</div>';
    ...
    switch(checkout){
        ...
        case 'american_rv':
            if(custPartID > 0){
                ...
                checkoutHTML += '<img src="//www.curthitch.biz/widget/checkout.png" alt="Checkout" />';
                checkoutHTML += '</a><br />';
            }
            break;
        case 'custom':
